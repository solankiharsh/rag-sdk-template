"""
Ragsdk Core Example: Multimodal Prompt with Few Shots
...
class ImagePrompt(Prompt[ImagePromptInput, ImagePromptOutput]):
    ...
    few_shots = [
        ...
        (
            ...
            ImagePromptOutput(
                description=("Once upon a time, in an enchanted forest, "
                            "a noble wolf roamed under the moonlit sky.")
            ),
        ),
        (
            ImagePromptInput(
            ...
            ImagePromptOutput(
                description="A lone astronaut drifts through the void, "
                           "bathed in the eerie glow of distant galaxies."
            ),
        ),
    ]
