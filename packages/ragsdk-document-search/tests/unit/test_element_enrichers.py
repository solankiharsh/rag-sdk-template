...
from ragsdk.document_search.ingestion.enrichers.image import (
...
@pytest.mark.parametrize(
    ...
    [
        ("ragsdk.document_search.ingestion.enrichers.image:ImageElementEnricher", ImageElementEnricher),
    ...
    config = ObjectConstructionConfig.model_validate(
        {
            ...
            "config": {
                "llm": {
                    "type": "LiteLLM",
                    "prompt": "ragsdk.document_search.ingestion.enrichers.image:ImageDescriberPrompt",
                },
            },
        }
    )
