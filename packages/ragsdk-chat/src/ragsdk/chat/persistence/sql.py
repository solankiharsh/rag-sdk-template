...
class SQLHistoryPersistenceOptions(Options):
    ...
    conversations_table: str = "ragsdk_conversations"
    interactions_table: str = "ragsdk_chat_interactions"


SQLHistoryPersistenceOptionsT = TypeVar(
    "SQLHistoryPersistenceOptionsT",
    bound=SQLHistoryPersistenceOptions
)
...
class SQLHistoryPersistence(HistoryPersistenceStrategy):
    ...
    def __init__(
        ...
        self.Conversation: Any = create_conversation_model(
            self.options.conversations_table, self._base
        )
