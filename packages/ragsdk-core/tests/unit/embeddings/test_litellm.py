...
from ragsdk.core.embeddings.dense.litellm import LiteLLMEmbedder, LiteLLMEmbedderOptions
...
async def test_litellm_embedder_get_vector_size_with_none_dimensions():
    ...
    with patch("ragsdk.core.embeddings.dense.litellm.litellm.aembedding") as mock_embedding:
