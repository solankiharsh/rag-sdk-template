...
from ragsdk.core.audit.traces import clear_trace_handlers, set_trace_handlers, traceable
...
def test_add_numbers_cli_trace_handler_with_verbose():
    ...
    if os.getenv("RAGSDK_VERBOSE"):
        assert os.getenv("RAGSDK_VERBOSE") == "0", "Should run test with RAGSDK_VERBOSE=0"
