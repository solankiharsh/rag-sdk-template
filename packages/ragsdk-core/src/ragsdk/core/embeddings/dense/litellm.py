...
from ragsdk.core.embeddings.base import VectorSize
from ragsdk.core.embeddings.dense.base import DenseEmbedder
from ragsdk.core.embeddings.exceptions import (
...
class LiteLLMEmbedder(DenseEmbedder[LiteLLMEmbedderOptions]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            router: Router to be used to [route requests]
                (https://docs.litellm.ai/docs/routing) to different models.
        """
    ...
    async def embed_text(
        self,
        data: list[str],
        options: LiteLLMEmbedderOptions | None = None
    ) -> list[list[float]]:
        """
    ...
    def from_config(cls, config: dict[str, Any]) -> Self:
        ...
        Args:
            config: A configuration object containing the configuration
                for initializing the LiteLLMEmbedder instance.
