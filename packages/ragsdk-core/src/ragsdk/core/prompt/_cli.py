...
from ragsdk.cli import print_output
from ragsdk.core.config import core_config
from ragsdk.core.llms.base import LLM, LLMType
from ragsdk.core.prompt.discovery import PromptDiscovery
...
def promptfoo(
    ...
    """
    from ragsdk.core.prompt.promptfoo import generate_configs
