...
from ragsdk.core.llms.base import LLMType
from ragsdk.core.utils._pyproject import get_config_from_yaml, get_config_instance


class CoreConfig(BaseModel):
    """
    Configuration for the ragsdk-core package, loaded from downstream projects' pyproject.toml files.
    """
    ...
    llm_preference_factories: dict[LLMType, str] = {
        LLMType.TEXT: "ragsdk.core.llms.factory:simple_litellm_factory",
        LLMType.VISION: "ragsdk.core.llms.factory:simple_litellm_vision_factory",
        LLMType.STRUCTURED_OUTPUT: "ragsdk.core.llms.factory:simple_litellm_structured_output_factory",
    }

    # Path to functions that returns instances of diffrent types of Ragsdk objects
    component_preference_factories: dict[str, str] = {}

    # Path to a YAML file with preferred configuration of varius Ragsdk objects
