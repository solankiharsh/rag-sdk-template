...
@dataclass
class AgentResult(Generic[PromptOutputT]): # type: ignore
    """
...
class AgentOptions(Options, Generic[LLMClientOptionsT]): # type: ignore
    """
...
class Agent(
    ConfigurableComponent[AgentOptions[LLMClientOptionsT]],
    Generic[LLMClientOptionsT, PromptInputT, PromptOutputT]  # type: ignore
):
    """
