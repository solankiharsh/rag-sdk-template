...
from ragsdk.core.config import CoreConfig, core_config
...
- setting the preferred {type_name} configuration in your project's [b]pyproject.toml[/b] file
  (see https://github.com/solankiharsh/rag-sdk-50-days-of-learninghow-to/project/component_preferences/ for more information)""")
